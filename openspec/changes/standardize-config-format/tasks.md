...
- [ ] **Task 1.1**: Update `ProjectConfig` model to support TOML serialization
...
- [ ] **Task 1.2**: Implement TOML reading in `ProjectConfig.from_file()`
...
- [ ] **Task 1.3**: Implement TOML writing in `ProjectConfig.to_file()`
...
- [ ] **Task 1.4**: Write unit tests for ProjectConfig TOML operations
...
- [ ] **Task 2.1**: Implement JSON detection and auto-conversion logic
...
- [ ] **Task 2.2**: Implement auto-write of TOML on first write after migration detection
...
- [ ] **Task 2.3**: Write migration tests
...
- [ ] **Task 3.1**: Update JSON backend storage adapter to use new ProjectConfig TOML methods
...
- [ ] **Task 3.2**: Update storage tests to verify TOML format
...
- [ ] **Task 4.1**: Verify `tasky project init` creates TOML config
...
- [ ] **Task 4.2**: Update project settings loading in `tasky-settings`
...
- [ ] **Task 5.1**: Test `tasky project init` creates TOML format
...
- [ ] **Task 5.2**: Write integration tests for TOML config workflow
...
- [ ] **Task 6.1**: Test legacy JSON config still works (with warning)
...
- [ ] **Task 6.2**: Test migration pathway: JSON → TOML
...
- [ ] **Task 7.3**: Update documentation and comments
