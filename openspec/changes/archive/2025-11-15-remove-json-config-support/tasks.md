...
- [x] **Task 1: Inventory all JSON references**
...
- [x] **Task 2: Remove JSON loading from tasky-projects**
...
- [x] **Task 3: Remove JSON handling from tasky-settings sources**
...
- [x] **Task 4: Delete JSON-focused tests**
...
- [x] **Task 5: Purge JSON references from documentation & examples**
