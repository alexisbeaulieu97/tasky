...
- [x] **Task 1.1**: Define `TaskFilter` model in `tasky-tasks`
...
- [x] **Task 1.2**: Extend `TaskRepository` protocol with `find_tasks()` method
...
- [x] **Task 1.3**: Update `tasky-tasks` package exports
...
- [x] **Task 1.4**: Write unit tests for `TaskFilter` model
...
- [x] **Task 2.1**: Add `find_tasks()` method to `TaskService`
...
- [x] **Task 2.2**: Add convenience methods for common filter combinations
...
- [x] **Task 2.3**: Write unit tests for service filtering
...
- [x] **Task 3.1**: Implement `find_tasks()` in `JsonTaskRepository`
...
- [x] **Task 3.2**: Write integration tests for JSON filtering
...
- [x] **Task 4.1**: Add `--created-after` option to `task list` command
...
- [x] **Task 4.2**: Add `--created-before` option to `task list` command
  - Add parameter: `created_before: str | None = typer.Option(None, "--created-before", help="...")`
  - Provide help text with ISO 8601 format example
  - **Validation**: Run `uv run tasky task list --help` and verify option appears

- [x] **Task 4.3**: Add `--search` option to `task list` command
...
- [x] **Task 4.4**: Implement date parsing and validation
...
- [x] **Task 4.5**: Build `TaskFilter` from CLI options
...
- [x] **Task 4.6**: Integrate filtering with task service
...
- [x] **Task 4.7**: Implement comprehensive error handling
...
- [x] **Task 5.1**: Add end-to-end CLI tests for advanced filtering
...
- [x] **Task 5.2**: Test backward compatibility
...
- [x] **Task 5.3**: Run full test suite and fix issues
...
- [x] **Task 5.5**: Manual smoke testing
...
- [x] **Task 5.6**: Documentation & examples
