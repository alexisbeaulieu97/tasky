...
- [ ] **Task 1.1**: Add status indicator symbols to task display
...
- [ ] **Task 1.2**: Include task IDs in output
...
- [ ] **Task 1.3**: Implement task sorting by status
...
- [ ] **Task 2.1**: Add task count summary line
...
- [ ] **Task 2.2**: Handle empty task list
...
- [ ] **Task 2.3**: Format timestamps for --long flag
...
- [ ] **Task 3.1**: Ensure compatibility with existing filtering
...
- [ ] **Task 3.3**: Add unit tests for formatting
...
- [ ] **Task 4.2**: Code quality and test coverage
...
- [ ] **Task 4.3**: Run linting and formatting
